...
const forHourBtn = document.querySelector('#for-hour-btn');
const forHourModal = document.querySelector('#for-hour');
...
const modals = [mobileMenu, myVideoModal, forHourModal];
const buttons = [mobileMenuBtn, myVideoBtn, forHourBtn];
...
function hideModalOnMobileMenuElementsClick() {
    const MOBILE_MENU_ITEM_CLOSE_DELAY = 200;
